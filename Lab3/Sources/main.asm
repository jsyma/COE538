...
lbl         MOVB  #$90,ATDCTL5  ;r.just., unsign., sing.conv., mult., ch0, start conv.
            ...
            LDAA  #$7F            ;load the ch4 result into AccA
            LDAB  #$27
                        ;AccB = 39
            ...
            JSR   int2BCD
            JSR   BCD2ASC
            LDAA  #$06          ;move LCD cursor to the 1st row, end of msg1
            JSR   cmd2LCD     ;"
...
initAD      MOVB  #$C0,ATDCTL2;#%11000000  ;power up AD, select fast flag clear
